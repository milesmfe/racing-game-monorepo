...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__repo_game_types: string;
	...
	export const npm_package_dependencies__repo_game_ui: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__repo_game_types: string;
		...
		npm_package_dependencies__repo_game_ui: string;
